---
title: "16S ML models comparison and RF vip"
...
```{r}
pseq = Plaque538_16S_Species_ps_CLR
```
...
auroc_auprc_values_16S =  full_join(auroc_values, auprc_values)
auroc_auprc_values_16S

saveRDS(auroc_auprc_values_16S, here("Analysis/Plaque538_Combined/Plaque538_16S/16S_A5_ML/auroc_auprc_values_16S.rds"))
```
...
roc_curve_data_2 <- roc_curve_data %>%
  left_join(auroc_auprc_values_16S, by = "model_id") %>% 
...
ggplot(roc_curve_data_2, aes(x = 1 - specificity, y = sensitivity, color = Model_performance)) +
  ...
  labs(title = "16S_AUROC_Comparison") +
  theme(
...
ggsave(here("Analysis/Plaque538_Combined/Plaque538_16S/16S_A5_ML/16S_AUROC_Comparison.png"))
