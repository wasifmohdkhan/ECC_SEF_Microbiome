...
Maaslin2_Heatmap_Species_without_confounders <-
  readRDS(here("Plaque538_Combined/Plaque538_16S/16S_A4_LM/Maaslin2_Heatmap_Species_without_confounders.rds"))

Maaslin2_Heatmap_Genus_without_confounders <-
  readRDS(here("Plaque538_Combined/Plaque538_16S/16S_A4_LM/Maaslin2_Heatmap_Genus_without_confounders.rds"))
...
ggsave(here("Plaque538_Combined/Plaque538_16S/16S_A4_LM/combined_Maaslin2_Species_Genus_heatmap.png"), 
       combined_Maaslin2_Species_Genus_heatmap,
       width = 55, height = 64, units = "cm", dpi = 600)
ggsave(here("Plaque538_Combined/Plaque538_16S/16S_A4_LM/combined_Maaslin2_Species_Genus_heatmap.tiff"), 
       combined_Maaslin2_Species_Genus_heatmap,
       width = 55, height = 64, units = "cm", dpi = 600)
```
