---
title: "ITS ML models comparison and RF vip"
...
```{r}
pseq = Plaque538_ITS_Species_ps_CLR
```
...
auroc_auprc_values_ITS =  full_join(auroc_values, auprc_values)
auroc_auprc_values_ITS

saveRDS(auroc_auprc_values_ITS, here("Plaque538_Combined/Plaque538_ITS/Plaque538_ITS_A5_ML/auroc_auprc_values_ITS.rds"))
```
...
roc_curve_data_2 <- roc_curve_data %>%
  left_join(auroc_auprc_values_ITS, by = "model_id") %>% 
...
ggplot(roc_curve_data_2, aes(x = 1 - specificity, y = sensitivity, color = Model_performance)) +
  ...
  labs(title = "ITS_AUROC_Comparison") +
  theme(
...
ggsave(here("Plaque538_Combined/Plaque538_ITS/Plaque538_ITS_A5_ML/ITS_AUROC_Comparison.png"))
...
ggplot(VIP_df, aes(y = Variable, x = Relative_importance)) +
