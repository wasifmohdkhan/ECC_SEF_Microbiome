---
title: "ITS beta diversity and sdoh"
...
#     xlab("R-squared") +
#     ylab("Variables") +
#     ggtitle("ITS Bray–Curtis (beta) Diversity with adj_p_value") +
#     theme_minimal() +
...
# 
# ggsave(file =
#          here("Plaque538_Combined/Plaque538_ITS/Plaque538_ITS_A9_Diversity/ITS_Bray_Diversity.png"),
#        width = 8, height = 6)
```


```{r}
Plaque538_ITS_Species_Bray_Diversity = 
...
# save
saveRDS(Plaque538_ITS_Species_Bray_Diversity,
        here("Analysis/Plaque538_Combined/Plaque538_ITS/ITS_A9_Diversity/Plaque538_ITS_Species_Bray_Diversity.rds")
        )
```
